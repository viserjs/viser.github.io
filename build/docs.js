...
module.exports = !__webpack_require__(366)(function () {
...
const oui_dom_utils_1 = __webpack_require__(44);
const oui_dom_events_1 = __webpack_require__(45);
/**
 * Language Utils
 */
exports.ALL_PAGE_LANGUAGES = ['en', 'cn'];
exports.DEFAULT_PAGE_LANGUAGE = 'en';
exports.getPageLanguage = () => {
...
exports.setPageLanguage = (language) => {
    window.localStorage.setItem('page_language', language);
};
exports.initPageLanguage = () => {
    const pageLanguageInStore = exports.getPageLanguage();
...
exports.getNameByLanguage = (o) => {
    const language = exports.getPageLanguage();
    switch (language) {
        case 'en': {
            if (o && o.enName) {
                return o.enName;
 ...
 * Route Utils
 */
exports.generateHashtag = (folder, item) => {
    if (folder && item) {
        return `#/${folder}/${item}`;
    }
    else if (folder) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const mds_1 = __webpack_require__(754);
const locale_1 = __webpack_require__(93);
const utils_1 = __webpack_require__(43);
__webpack_require__(755);
const timers_1 = __webpack_require__(756);
const navTpl = __webpack_require__(769);
...
class Docs {
    ...
    getDocsFolderAndItem() {
        const { folder, item } = utils_1.getFolderAndItem();
        return {
    ...
    renderLanguage() {
        let pageLanguageInStore = utils_1.getPageLanguage();
        ...
        utils_1.ALL_PAGE_LANGUAGES.forEach((lang) => {
    ...
    renderLeftMenu() {
        ...
        const menuList = mds_1.default.map((v) => {
            const folderMatched = v.folderKey === folder;
            return Object.assign({}, v, { folderDisplayName: utils_1.getNameByLanguage(v), mds: v.mds.map((o) => {
                    const itemMatched = o.itemKey === item;
                    return Object.assign({}, o, { itemDisplayName: utils_1.getNameByLanguage(o), linkName: utils_1.generateHashtag(v.folderKey, o.itemKey), activeClass: folderMatched && itemMatched ? 'active' : '' });
                }) });
        });
    ...
    renderContent() {
        const language = utils_1.getPageLanguage();
        const { folder, item } = this.getDocsFolderAndItem();
        let content = '';
        try {
            content = __webpack_require__(770)(`./${folder}/${item}/${language}.md`);
        }
        catch (err) {
            console.error(err);
        }
...
var $export = __webpack_require__(758);
var userAgent = __webpack_require__(768);
var slice = [].slice;
...
var ctx = __webpack_require__(759);
...
var aFunction = __webpack_require__(760);
...
var dP = __webpack_require__(762);
var createDesc = __webpack_require__(767);
...
var IE8_DOM_DEFINE = __webpack_require__(764);
var toPrimitive = __webpack_require__(766);
...
module.exports = !__webpack_require__(129) && !__webpack_require__(366)(function () {
...
var map = {
	"./guide/installation/cn.md": 771,
	"./guide/installation/en.md": 772,
	"./guide/introduction/cn.md": 773,
	"./guide/introduction/en.md": 774,
	"./guide/usage/cn.md": 775,
	"./guide/usage/en.md": 776
};
