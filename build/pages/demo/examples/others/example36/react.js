...
var data = dv.rows;
var guideDv = new DataSet.View().source(dv);
guideDv.transform({
    type: 'aggregate',
    fields: ['y'],
    operations: ['median'],
...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement(viser_react_1.Chart, { forceFit: true, height: 440, data: data, scale: scale, padding: [20, 20, 120, 50] },
            React.createElement(viser_react_1.Tooltip, null),
            React.createElement(viser_react_1.Legend, { dataKey: "name", position: "bottom" }),
            React.createElement(viser_react_1.Legend, { dataKey: "_hStep", show: false }),
            React.createElement(viser_react_1.Legend, { dataKey: "_wStep", show: false }),
            React.createElement(viser_react_1.Point, { shape: "square", position: "x*y", color: "name", size: ['_hStep', function (hStep) { return Math.min(90 * hStep, 5); }] }),
            guideData.map(function (row, i) {
                return (React.createElement(viser_react_1.Guide, { key: "guide-text-" + i, type: "text", top: true, position: [0, row.medianY], content: row.State, offsetX: -10, style: {
                        fill: '#666',
                        fontSize: 24,
                        fontWeight: 'bold',
                        textAlign: 'right'
