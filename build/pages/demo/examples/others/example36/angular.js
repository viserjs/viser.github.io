...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.data = data;
        this.scale = scale;
        this.padding = [20, 20, 120, 50];
        this.legendShow = false;
        this.pointSize = ['_hStep', function (hStep) { return Math.min(90 * hStep, 5); }];
        this.guideData = guideData;
        this.guideTop = true;
        this.getGuidePosition = function (row) { return [0, row.medianY]; };
        this.getGuideContent = function (row) { return row.State; };
        this.guideOffsetX = -10;
        this.guideStyle = {
            fill: '#666',
            fontSize: 24,
            fontWeight: 'bold',
