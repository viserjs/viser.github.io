...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(viser_react_1.Chart, { forceFit: true, height: 400, padding: [40, 100, 80], data: data },
                React.createElement(viser_react_1.Legend, __assign({}, legendOpt)),
                React.createElement(viser_react_1.Tooltip, null),
                React.createElement(viser_react_1.Coord, { type: "polar", radius: 0.85 }),
                React.createElement(viser_react_1.Axis, __assign({ dataKey: "value" }, axisOpt)),
                React.createElement(viser_react_1.StackBar, { position: "direction*value", color: ['level', colors], size: 35 }))));
    };
    return App;
}(React.Component));
exports.default = App;
