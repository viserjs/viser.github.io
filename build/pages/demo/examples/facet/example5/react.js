    ...
    App.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(viser_react_1.Chart, { forceFit: true, height: 400, data: data, scale: scale },
                ...
                React.createElement(viser_react_1.Facet, { type: "list", fields: ['cut'], cols: 3, padding: 30 },
                    React.createElement(viser_react_1.FacetView, null,
                        React.createElement(viser_react_1.Point, { position: "carat*price", color: "cut", opacity: 0.3, size: 3, shape: "circle" }))))));
    };
    return App;
}(React.Component));
exports.default = App;
