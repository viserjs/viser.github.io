...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement(viser_react_1.Chart, { forceFit: true, height: 400, data: data, scale: scale },
            ...
            React.createElement(viser_react_1.Line, { position: "month*temperature", color: "city" }),
            React.createElement(viser_react_1.Point, { position: "month*temperature", color: "city", size: 4, style: { stroke: '#fff', lineWidth: 1 }, shape: "circle" })));
    };
    return App;
}(React.Component));
exports.default = App;
