    ...
    App.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(viser_react_1.Chart, { forceFit: true, height: 400, data: dv, scale: scale },
                ...
                React.createElement(viser_react_1.Coord, { type: "polar", innerRadius: 0.5 }),
                React.createElement(viser_react_1.Axis, null),
                React.createElement(viser_react_1.Legend, null),
                React.createElement(viser_react_1.Box, { position: "x*range", active: true, size: 60, color: "x", tooltip: ['x*low*q1*median*q3*high', function (x, low, q1, median, q3, high) {
                            return {
                                name: x,
                                low: low,
                                q1: q1,
