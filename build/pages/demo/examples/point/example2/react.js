...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        ...
        return (React.createElement(viser_react_1.Chart, { forceFit: true, height: 400, data: data },
            ...
            React.createElement(viser_react_1.Point, { position: "height*weight", color: "gender", size: 4, opacity: 0.65, tooltip: ['gender*height*weight', function (gender, height, weight) {
                        return {
                            name: gender,
