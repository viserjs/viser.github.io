...
(0, _timers.setTimeout)(function () {
  console.assert(typeof _timers.setTimeout !== 'undefined', '[IMPORT]:', 'setTimeout', 'from', 'timers', 'is undefined.');
}, 0);
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      var typeResult = search.match(typeReg);
      var chartType = typeResult ? typeResult[2] : Object.keys(codeConfig)[0];
      this.attrs.chartType = chartType;

      var exampleReg = new RegExp('(^|&)example=([^&]*)(&|$)');
      var exampleResult = search.match(exampleReg);
      var exampleIndex = exampleResult ? parseInt(exampleResult[2], 10) : 0;

      var example = codeConfig[chartType].examples[exampleIndex] || codeConfig[chartType].examples[0] || {};
      var path = example.path,
          cnName = example.cnName,
          enName = example.enName;
      ...
      try {
        ...
        this.attrs.code = {
          jsonCode: jsonCode, reactCode: reactCode, vueCode: vueCode, angularCode: angularCode,
    ...
    value: function render() {
      ...
      var runCode = code['jsonCode'];
      runCode.config.chart.container = 'case-mount-node';
      Viser.default(runCode.config);

      ALL_FRAMEWORK.forEach(function (framework) {
        _this.presetEditor(framework, code);
      });
    }
  }, {
    key: 'bindEvent',
    value: function bindEvent() {
      ...
      $('.case-box .op .run').on('click', function () {
        ...
        var data = self.getJsfiddleData(index);
        var formAttributes = {
          method: 'post',
    ...
    key: 'refreshCase',
    value: function refreshCase(framework) {
    ...
    key: 'getJsfiddleData',
    value: function getJsfiddleData(index) {
      var framework = this.attrs.framework;
      switch (framework) {
        case 'json':
    ...
    key: 'getJsfiddleJsonData',
    value: function getJsfiddleJsonData(index) {
      var code = this.attrs.codes[index]['jsonCode'];
    ...
    key: 'getJsfiddleVueData',
    value: function getJsfiddleVueData(index) {
      var _attrs$codes$index = this.attrs.codes[index],
          vueCode = _attrs$codes$index.vueCode,
          jsonCode = _attrs$codes$index.jsonCode;
    ...
    key: 'getJsfiddleReactData',
    value: function getJsfiddleReactData(index) {
      var _attrs$codes$index2 = this.attrs.codes[index],
          reactCode = _attrs$codes$index2.reactCode,
          jsonCode = _attrs$codes$index2.jsonCode;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"common-nav-folder\">\n    <h3 class=\"common-nav-title\">\n      <i class=\"iconfont icon-"
    ...
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.examples : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 2, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </ul>\n  </div>\n";
  ...
  return "        <li class=\"common-nav-item "
    ...
    + alias2(alias1(blockParams[0][1], depth0))
    + "\">"
    + alias2(alias1((depth0 != null ? depth0.enName : depth0), depth0))
    + "</a>\n        </li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.menuList : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 2, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n\n";
