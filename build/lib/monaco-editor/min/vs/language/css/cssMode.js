...
!function (e) { if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    if (!t) {
        var r = [], i = { textDocument: n, edits: r };
...
} return this._lineOffsets; }, e.prototype.positionAt = function (e) { e = Math.max(Math.min(e, this._content.length), 0); var n = this.getLineOffsets(), r = 0, i = n.length; if (0 === i)
    return t.create(0, e); for (; i > r;) {
    ...
    return 0; var t = n[e.line], r = e.line + 1 < n.length ? n[e.line + 1] : this._content.length; return Math.max(Math.min(t + e.character, r), t); }, Object.defineProperty(e.prototype, "lineCount", { get: function () { return this.getLineOffsets().length; }, enumerable: !0, configurable: !0 }), e; }(); !function (e) { function n(e) { return "undefined" != typeof e; } function t(e) { return "undefined" == typeof e; } function r(e) { return e === !0 || e === !1; } function i(e) { return "[object String]" === s.call(e); } function o(e) { return "[object Number]" === s.call(e); } function a(e) { return "[object Function]" === s.call(e); } function u(e, n) { return Array.isArray(e) && e.every(n); } var s = Object.prototype.toString; e.defined = n, e.undefined = t, e["boolean"] = r, e.string = i, e.number = o, e.func = a, e.typedArray = u; }(A || (A = {})); }), define("vscode-languageserver-types", ["vscode-languageserver-types/main"], function (e) { return e; }), function (e) { if ("object" == typeof module && "object" == typeof module.exports) {
    var n = e(require, exports);
    void 0 !== n && (module.exports = n);
}
else
    "function" == typeof define && define.amd && define("vs/language/css/languageFeatures", ["require", "exports", "vscode-languageserver-types"], e); }(function (e, n) { function t(e) { switch (e) {
    case g.DiagnosticSeverity.Error: return monaco.Severity.Error;
    case g.DiagnosticSeverity.Warning: return monaco.Severity.Warning;
    case g.DiagnosticSeverity.Information:
    case g.DiagnosticSeverity.Hint:
    default: return monaco.Severity.Info;
} } function r(e, n) { var r = "number" == typeof n.code ? String(n.code) : n.code; return { severity: t(n.severity), startLineNumber: n.range.start.line + 1, startColumn: n.range.start.character + 1, endLineNumber: n.range.end.line + 1, endColumn: n.range.end.character + 1, message: n.message, code: r, source: n.source }; } function i(e) { return e ? { character: e.column - 1, line: e.lineNumber - 1 } : void 0; } function o(e) { return e ? new p(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1) : void 0; } function a(e) { var n = monaco.languages.CompletionItemKind; switch (e) {
    case g.CompletionItemKind.Text: return n.Text;
    case g.CompletionItemKind.Method: return n.Method;
    case g.CompletionItemKind.Function: return n.Function;
    case g.CompletionItemKind.Constructor: return n.Constructor;
    case g.CompletionItemKind.Field: return n.Field;
    case g.CompletionItemKind.Variable: return n.Variable;
    case g.CompletionItemKind.Class: return n.Class;
    case g.CompletionItemKind.Interface: return n.Interface;
    case g.CompletionItemKind.Module: return n.Module;
    case g.CompletionItemKind.Property: return n.Property;
    case g.CompletionItemKind.Unit: return n.Unit;
    case g.CompletionItemKind.Value: return n.Value;
    case g.CompletionItemKind.Enum: return n.Enum;
    case g.CompletionItemKind.Keyword: return n.Keyword;
    case g.CompletionItemKind.Snippet: return n.Snippet;
    case g.CompletionItemKind.Color: return n.Color;
    case g.CompletionItemKind.File: return n.File;
    case g.CompletionItemKind.Reference: return n.Reference;
} return n.Property; } function u(e) { return e ? Array.isArray(e) ? e : [e] : void 0; } function s(e) { switch (e) {
    case g.DocumentHighlightKind.Read: return monaco.languages.DocumentHighlightKind.Read;
    case g.DocumentHighlightKind.Write: return monaco.languages.DocumentHighlightKind.Write;
    case g.DocumentHighlightKind.Text: return monaco.languages.DocumentHighlightKind.Text;
} return monaco.languages.DocumentHighlightKind.Text; } function c(e) { return { uri: m.parse(e.uri), range: o(e.range) }; } function d(e) { if (e && e.changes) {
    var n = [];
    ...
    return { edits: n };
} } function f(e) { var n = monaco.languages.SymbolKind; switch (e) {
    case g.SymbolKind.File: return n.Array;
    case g.SymbolKind.Module: return n.Module;
    case g.SymbolKind.Namespace: return n.Namespace;
    case g.SymbolKind.Package: return n.Package;
    case g.SymbolKind.Class: return n.Class;
    case g.SymbolKind.Method: return n.Method;
    case g.SymbolKind.Property: return n.Property;
    case g.SymbolKind.Field: return n.Field;
    case g.SymbolKind.Constructor: return n.Constructor;
    case g.SymbolKind.Enum: return n.Enum;
    case g.SymbolKind.Interface: return n.Interface;
    case g.SymbolKind.Function: return n.Function;
    case g.SymbolKind.Variable: return n.Variable;
    case g.SymbolKind.Constant: return n.Constant;
    case g.SymbolKind.String: return n.String;
    case g.SymbolKind.Number: return n.Number;
    case g.SymbolKind.Boolean: return n.Boolean;
    case g.SymbolKind.Array: return n.Array;
} return n.Function; } function l(e, n) { return e.onCancellationRequested(function () { return n.cancel(); }), n; } Object.defineProperty(n, "__esModule", { value: !0 }); var g = e("vscode-languageserver-types"), m = monaco.Uri, p = monaco.Range, h = function () { function e(e, n) { var t = this; this._languageId = e, this._worker = n, this._disposables = [], this._listener = Object.create(null); var r = function (e) { var n = e.getModeId(); if (n === t._languageId) {
    var r;
