...
!function (e) { e.global = _amdLoaderGlobal; var t = function () { function t(e) { this.isWindows = e.isWindows, this.isNode = e.isNode, this.isElectronRenderer = e.isElectronRenderer, this.isWebWorker = e.isWebWorker; } return t.detect = function () { return new t({ isWindows: this._isWindows(), isNode: "undefined" != typeof module && !!module.exports, isElectronRenderer: "undefined" != typeof process && void 0 !== process.versions && void 0 !== process.versions.electron && "renderer" === process.type, isWebWorker: "function" == typeof e.global.importScripts }); }, t._isWindows = function () { return !!("undefined" != typeof navigator && navigator.userAgent && navigator.userAgent.indexOf("Windows") >= 0) || "undefined" != typeof process && "win32" === process.platform; }, t; }(); e.Environment = t; }(AMDLoader || (AMDLoader = {}));
var AMDLoader;
!function (e) { var t; !function (e) { e[e.LoaderAvailable = 1] = "LoaderAvailable", e[e.BeginLoadingScript = 10] = "BeginLoadingScript", e[e.EndLoadingScriptOK = 11] = "EndLoadingScriptOK", e[e.EndLoadingScriptError = 12] = "EndLoadingScriptError", e[e.BeginInvokeFactory = 21] = "BeginInvokeFactory", e[e.EndInvokeFactory = 22] = "EndInvokeFactory", e[e.NodeBeginEvaluatingScript = 31] = "NodeBeginEvaluatingScript", e[e.NodeEndEvaluatingScript = 32] = "NodeEndEvaluatingScript", e[e.NodeBeginNativeRequire = 33] = "NodeBeginNativeRequire", e[e.NodeEndNativeRequire = 34] = "NodeEndNativeRequire"; }(t = e.LoaderEventType || (e.LoaderEventType = {})); var r = function () { return function (e, t, r) { this.type = e, this.detail = t, this.timestamp = r; }; }(); e.LoaderEvent = r; var n = function () { function n(e) { this._events = [new r(t.LoaderAvailable, "", e)]; } return n.prototype.record = function (t, n) { this._events.push(new r(t, n, e.Utilities.getHighPerformanceTimestamp())); }, n.prototype.getEvents = function () { return this._events; }, n; }(); e.LoaderEventRecorder = n; var o = function () { function e() { } return e.prototype.record = function (e, t) { }, e.prototype.getEvents = function () { return []; }, e; }(); o.INSTANCE = new o, e.NullLoaderEventRecorder = o; }(AMDLoader || (AMDLoader = {}));
var AMDLoader;
!function (e) { var t = function () { function t() { } return t.fileUriToFilePath = function (e, t) { if (t = decodeURI(t), e) {
    if (/^file:\/\/\//.test(t))
        return t.substr(8);
    if (/^file:\/\//.test(t))
        return t.substr(5);
...
!function (e) { var t = function () { function t() { } return t.validateConfigurationOptions = function (t, r) { return "string" != typeof (r = r || {}).baseUrl && (r.baseUrl = ""), "boolean" != typeof r.isBuild && (r.isBuild = !1), "object" != typeof r.paths && (r.paths = {}), "object" != typeof r.config && (r.config = {}), void 0 === r.catchError && (r.catchError = t), "string" != typeof r.urlArgs && (r.urlArgs = ""), "function" != typeof r.onError && (r.onError = function (e) { return "load" === e.errorCode ? (console.error('Loading "' + e.moduleId + '" failed'), console.error("Detail: ", e.detail), e.detail && e.detail.stack && console.error(e.detail.stack), console.error("Here are the modules that depend on it:"), void console.error(e.neededBy)) : "factory" === e.errorCode ? (console.error('The factory method of "' + e.moduleId + '" has thrown an exception'), console.error(e.detail), void (e.detail && e.detail.stack && console.error(e.detail.stack))) : void 0; }), "object" == typeof r.ignoreDuplicateModules && Array.isArray(r.ignoreDuplicateModules) || (r.ignoreDuplicateModules = []), r.baseUrl.length > 0 && (e.Utilities.endsWith(r.baseUrl, "/") || (r.baseUrl += "/")), Array.isArray(r.nodeModules) || (r.nodeModules = []), ("number" != typeof r.nodeCachedDataWriteDelay || r.nodeCachedDataWriteDelay < 0) && (r.nodeCachedDataWriteDelay = 7e3), "function" != typeof r.onNodeCachedData && (r.onNodeCachedData = function (e, t) { e && ("cachedDataRejected" === e.errorCode ? console.warn("Rejected cached data from file: " + e.path) : "unlink" === e.errorCode || "writeFile" === e.errorCode ? (console.error("Problems writing cached data file: " + e.path), console.error(e.detail)) : console.error(e)); }), r; }, t.mergeConfigurationOptions = function (r, n, o) { void 0 === n && (n = null), void 0 === o && (o = null); var i = e.Utilities.recursiveClone(o || {}); return e.Utilities.forEachProperty(n, function (t, r) { "ignoreDuplicateModules" === t && void 0 !== i.ignoreDuplicateModules ? i.ignoreDuplicateModules = i.ignoreDuplicateModules.concat(r) : "paths" === t && void 0 !== i.paths ? e.Utilities.forEachProperty(r, function (e, t) { return i.paths[e] = t; }) : "config" === t && void 0 !== i.config ? e.Utilities.forEachProperty(r, function (e, t) { return i.config[e] = t; }) : i[t] = e.Utilities.recursiveClone(r); }), t.validateConfigurationOptions(r, i); }, t; }(); e.ConfigurationOptionsUtil = t; var r = function () { function r(e, r) { if (this._env = e, this.options = t.mergeConfigurationOptions(this._env.isWebWorker, r), this._createIgnoreDuplicateModulesMap(), this._createNodeModulesMap(), this._createSortedPathsRules(), "" === this.options.baseUrl) {
    ...
    if (r = this.sortedPathsRules[n], e.Utilities.startsWith(t, r.from)) {
        ...
        return i;
    } return [t]; }, r.prototype._addUrlArgsToUrl = function (t) { return e.Utilities.containsQueryString(t) ? t + "&" + this.options.urlArgs : t + "?" + this.options.urlArgs; }, r.prototype._addUrlArgsIfNecessaryToUrl = function (e) { return this.options.urlArgs ? this._addUrlArgsToUrl(e) : e; }, r.prototype._addUrlArgsIfNecessaryToUrls = function (e) { if (this.options.urlArgs)
    for (var t = 0, r = e.length; t < r; t++)
        e[t] = this._addUrlArgsToUrl(e[t]); return e; }, r.prototype.moduleIdToPaths = function (t) { if (!0 === this.nodeModulesMap[t])
    return this.isBuild() ? ["empty:"] : ["node|" + t]; var r, n = t; if (e.Utilities.endsWith(n, ".js") || e.Utilities.isAbsolutePath(n))
    e.Utilities.endsWith(n, ".js") || e.Utilities.containsQueryString(n) || (n += ".js"), r = [n];
else
    for (var o = 0, i = (r = this._applyPaths(n)).length; o < i; o++)
        this.isBuild() && "empty:" === r[o] || (e.Utilities.isAbsolutePath(r[o]) || (r[o] = this.options.baseUrl + r[o]), e.Utilities.endsWith(r[o], ".js") || e.Utilities.containsQueryString(r[o]) || (r[o] = r[o] + ".js")); return this._addUrlArgsIfNecessaryToUrls(r); }, r.prototype.requireToUrl = function (t) { var r = t; return e.Utilities.isAbsolutePath(r) || (r = this._applyPaths(r)[0], e.Utilities.isAbsolutePath(r) || (r = this.options.baseUrl + r)), this._addUrlArgsIfNecessaryToUrl(r); }, r.prototype.isBuild = function () { return this.options.isBuild; }, r.prototype.isDuplicateMessageIgnoredFor = function (e) { return this.ignoreDuplicateModulesMap.hasOwnProperty(e); }, r.prototype.getConfigForModule = function (e) { if (this.options.config)
    return this.options.config[e]; }, r.prototype.shouldCatchError = function () { return this.options.catchError; }, r.prototype.shouldRecordStats = function () { return this.options.recordStats; }, r.prototype.onError = function (e) { this.options.onError(e); }, r; }(); e.Configuration = r; }(AMDLoader || (AMDLoader = {}));
var AMDLoader;
!function (e) { var t = function () { function e(e) { this.actualScriptLoader = e, this.callbackMap = {}; } return e.prototype.load = function (e, t, r, n) { var o = this, i = { callback: r, errorback: n }; this.callbackMap.hasOwnProperty(t) ? this.callbackMap[t].push(i) : (this.callbackMap[t] = [i], this.actualScriptLoader.load(e, t, function () { return o.triggerCallback(t); }, function (e) { return o.triggerErrorback(t, e); })); }, e.prototype.triggerCallback = function (e) { var t = this.callbackMap[e]; delete this.callbackMap[e]; for (var r = 0; r < t.length; r++)
    t[r].callback(); }, e.prototype.triggerErrorback = function (e, t) { var r = this.callbackMap[e]; delete this.callbackMap[e]; for (var n = 0; n < r.length; n++)
    r[n].errorback(t); }, e; }(), r = function () { function e() { } return e.prototype.attachListeners = function (e, t, r) { var n = function () { e.removeEventListener("load", o), e.removeEventListener("error", i); }, o = function (e) { n(), t(); }, i = function (e) { n(), r(e); }; e.addEventListener("load", o), e.addEventListener("error", i); }, e.prototype.load = function (e, t, r, n) { var o = document.createElement("script"); o.setAttribute("async", "async"), o.setAttribute("type", "text/javascript"), this.attachListeners(o, r, n), o.setAttribute("src", t), document.getElementsByTagName("head")[0].appendChild(o); }, e; }(), n = function () { function e() { } return e.prototype.load = function (e, t, r, n) { try {
    importScripts(t), r();
}
catch (e) {
    n(e);
} }, e; }(), o = function () { function t(e) { this._env = e, this._didInitialize = !1, this._didPatchNodeRequire = !1; } return t.prototype._init = function (e) { if (!this._didInitialize) {
...
} }, t.prototype._initNodeRequire = function (t, r) { function n(e) { var t = e.constructor, r = function (t) { try {
    return e.require(t);
}
finally { } }; return r.resolve = function (r) { return t._resolveFilename(r, e); }, r.main = process.mainModule, r.extensions = t._extensions, r.cache = t._cache, r; } var o = r.getConfig().getOptionsLiteral().nodeCachedDataDir; if (o && !this._didPatchNodeRequire) {
    this._didPatchNodeRequire = !0;
    var i = this, s = t("module");
    s.prototype._compile = function (t, a) { t = t.replace(/^#!.*/, ""); var d = s.wrap(t), l = i._getCachedDataPath(o, a), u = { filename: a }; try {
        u.cachedData = i._fs.readFileSync(l);
    }
    catch (e) {
        u.produceCachedData = !0;
    } var c = new i._vm.Script(d, u), h = c.runInThisContext(u), f = i._path.dirname(a), p = n(this), g = [this.exports, p, this, a, f, process, e.global, Buffer], v = h.apply(this.exports, g); return i._processCachedData(r, c, l), v; };
} }, t.prototype.load = function (r, n, o, i) { var s = this, a = r.getConfig().getOptionsLiteral(), d = a.nodeRequire || e.global.nodeRequire, l = a.nodeInstrumenter || function (e) { return e; }; this._init(d), this._initNodeRequire(d, r); var u = r.getRecorder(); if (/^node\|/.test(n)) {
    ...
    r.enqueueDefineAnonymousModule([], function () { return h; }), o();
}
else
    n = e.Utilities.fileUriToFilePath(this._env.isWindows, n), this._fs.readFile(n, { encoding: "utf8" }, function (e, d) { if (e)
        i(e);
    else {
...
!function (e) { var t = function () { function t(e) { var t = e.lastIndexOf("/"); this.fromModulePath = -1 !== t ? e.substr(0, t + 1) : ""; } return t._normalizeModuleId = function (e) { var t, r = e; for (t = /\/\.\//; t.test(r);)
    ...
    var s = o[i].match(/(.*):(\d+):(\d+)\)?$/);
    if (s) {
        var a = s[1], d = s[2], l = s[3], u = Math.max(a.lastIndexOf(" ") + 1, a.lastIndexOf("(") + 1);
    ...
    return null; for (var e = [], t = 0, r = 0, n = this._modules2.length; r < n; r++) {
    var o = this._modules2[r];
    if (o) {
        var i = this._buildInfoPath[o.id] || null, a = this._buildInfoDefineStack[o.id] || null, d = this._buildInfoDependencies[o.id];
        e[t++] = { id: o.strId, path: i, defineLocation: i && a ? s._findRelevantLocationInStack(i, a) : null, dependencies: d, shim: null, exports: o.exports };
    }
    ...
    this._modules2[l] = u, this._config.isBuild() && (this._buildInfoDefineStack[l] = s, this._buildInfoDependencies[l] = u.dependencies.map(function (e) { return d._moduleIdProvider.getStrModuleId(e.id); })), this._resolve(u);
} }, s.prototype._normalizeDependency = function (e, t) { if ("exports" === e)
    return o.EXPORTS; if ("module" === e)
    return o.MODULE; if ("require" === e)
    return o.REQUIRE; var r = e.indexOf("!"); if (r >= 0) {
    var n = t.resolveModule(e.substr(0, r)), s = t.resolveModule(e.substr(r + 1)), a = this._moduleIdProvider.getModuleId(n + "!" + s), d = this._moduleIdProvider.getModuleId(n);
    return new i(a, d, s);
} return new o(this._moduleIdProvider.getModuleId(t.resolveModule(e))); }, s.prototype._normalizeDependencies = function (e, t) { for (var r = [], n = 0, o = 0, i = e.length; o < i; o++)
    r[n++] = this._normalizeDependency(e[o], t); return r; }, s.prototype._relativeRequire = function (t, r, n, o) { if ("string" == typeof r)
    return this.synchronousRequire(r, t); this.defineModule(e.Utilities.generateAnonymousModule(), r, n, o, null, t); }, s.prototype.synchronousRequire = function (e, r) { void 0 === r && (r = new t(e)); var n = this._normalizeDependency(e, r), o = this._modules2[n.id]; if (!o)
    throw new Error("Check dependency list! Synchronous require cannot resolve module '" + e + "'. This is the first mention of this module!"); if (!o.isComplete())
    throw new Error("Check dependency list! Synchronous require cannot resolve module '" + e + "'. This module has not been resolved completely yet."); return o.exports; }, s.prototype.configure = function (t, r) { var n = this._config.shouldRecordStats(); this._config = r ? new e.Configuration(this._env, t) : this._config.cloneAndMerge(t), this._config.shouldRecordStats() && !n && (this._recorder = null); }, s.prototype.getConfig = function () { return this._config; }, s.prototype._onLoad = function (e) { if (null !== this._currentAnnonymousDefineCall) {
...
} s || this._config.onError(r); }, s.prototype._hasDependencyPath = function (e, t) { var r = this._modules2[e]; if (!r)
    return !1; for (var n = [], o = 0, i = this._moduleIdProvider.getMaxModuleId(); o < i; o++)
    n[o] = !1; var s = []; for (s.push(r), n[e] = !0; s.length > 0;) {
...
} return !1; }, s.prototype._findCyclePath = function (e, t, r) { if (e === t || 50 === r)
    return [e]; var n = this._modules2[e]; if (!n)
    return null; for (var o = n.dependencies, i = 0, s = o.length; i < s; i++) {
    var a = this._findCyclePath(o[i].id, t, r + 1);
    if (null !== a)
        return a.push(e), a;
} return null; }, s.prototype._createRequire = function (t) { var r = this, n = function (e, n, o) { return r._relativeRequire(t, e, n, o); }; return n.toUrl = function (e) { return r._config.requireToUrl(t.resolveModule(e)); }, n.getStats = function () { return r.getLoaderEvents(); }, n.__$__nodeRequire = e.global.nodeRequire, n; }, s.prototype._loadModule = function (t) { var r = this; if (!this._modules2[t] && !this._knownModules2[t]) {
    this._knownModules2[t] = !0;
    var n = this._moduleIdProvider.getStrModuleId(t), o = this._config.moduleIdToPaths(n);
    this._env.isNode && -1 === n.indexOf("/") && o.push("node|" + n);
    var i = -1, s = function (n) { if (++i >= o.length)
        r._onLoadError(t, n);
    else {
        var a = o[i], d = r.getRecorder();
        if (r._config.isBuild() && "empty:" === a)
            return r._buildInfoPath[t] = a, r.defineModule(r._moduleIdProvider.getStrModuleId(t), [], null, null, null), void r._onLoad(t);
        d.record(e.LoaderEventType.BeginLoadingScript, a), r._scriptLoader.load(r, a, function () { r._config.isBuild() && (r._buildInfoPath[t] = a), d.record(e.LoaderEventType.EndLoadingScriptOK, a), r._onLoad(t); }, function (t) { d.record(e.LoaderEventType.EndLoadingScriptError, a), s(t); });
    } };
    s(null);
} }, s.prototype._loadPluginDependency = function (e, r) { var n = this; if (!this._modules2[r.id] && !this._knownModules2[r.id]) {
    this._knownModules2[r.id] = !0;
    var o = function (e) { n.defineModule(n._moduleIdProvider.getStrModuleId(r.id), [], e, null, null); };
...
} }, s.prototype._resolve = function (e) { for (var t = this, r = e.dependencies, n = 0, s = r.length; n < s; n++) {
    var a = r[n];
    if (a !== o.EXPORTS)
        if (a !== o.MODULE)
            if (a !== o.REQUIRE) {
                ...
                if (d && d.isComplete())
                    ...
                    l.reverse(), l.push(a.id), console.warn(l.map(function (e) { return t._moduleIdProvider.getStrModuleId(e); }).join(" => \n")), e.unresolvedDependenciesCount--;
                }
...
} 0 === e.unresolvedDependenciesCount && this._onModuleComplete(e); }, s.prototype._onModuleComplete = function (e) { var t = this, r = this.getRecorder(); if (!e.isComplete()) {
    for (var n = e.dependencies, i = [], s = 0, a = n.length; s < a; s++) {
        ...
        if (d !== o.EXPORTS)
            if (d !== o.MODULE)
                ...
                i[s] = { id: e.strId, config: function () { return t._config.getConfigForModule(e.strId); } };
        else
            i[s] = e.exports;
    }
...
} }, s; }(); e.ModuleManager = s; }(AMDLoader || (AMDLoader = {}));
var define, AMDLoader;
!function (e) { function t() { (o = function (e, t, r) { "string" != typeof e && (r = t, t = e, e = null), "object" == typeof t && Array.isArray(t) || (r = t, t = null), t || (t = ["require", "exports", "module"]), e ? n.defineModule(e, t, r, null, null) : n.enqueueDefineAnonymousModule(t, r); }).amd = { jQuery: !0 }; var t = function (e, t) { void 0 === t && (t = !1), n.configure(e, t); }; (i = function () { if (1 === arguments.length) {
