...
const getString = (data: any, type: string = 'js'): string => {
  ...
  try {
    if (type === 'js') {
      result = `var theme = ${JSON.stringify(
        obj,
        null,
        2,
...
class App extends React.Component<any, any> {
  ...
  public handleChangeTheme = (path, e, afterFix = null) => {
    this.props.setCurrentTheme({
      path,
      value: afterFix ? e.target.value + afterFix : e.target.value,
    });
  };
  ...
  public handleCopy = (str: string, path: string) => {
    ...
    const mess = `<span class="${className}">${getTransText(
      'download/copytip',
      pageLan,
    )}</span>`;
    const self = this;
      ...
      <div className="theme-left theme-pannel">
        ...
        <TabSld title={getTransText('basic', pageLan)}>
          ...
          {currentTheme.theme.colors.map((color, index) => {
            ...
            return (
              <Input
                ...
                {...label}
                showColor={true}
                completeSelect={color =>
                  this.handleGetColor('colors/' + index, color)
                }
          ...
          <div className="ctrl-btn">
            <span className="item" onClick={() => changeColors('increase')}>
              {getTransText('increase', pageLan)}
            </span>
            {currentTheme.theme.colors.length > 1 && (
              <span className="item" onClick={() => changeColors('decrease')}>
                {getTransText('decrease', pageLan)}
              </span>
            )}
          </div>
          {/*=========*/}
        </TabSld>
        <TabSld title={getTransText('label', pageLan)}>
          {/*文本样式*/}
          <h5 style={{ paddingTop: 0, border: 'none' }}>
            {getTransText('label/defaultLabel', pageLan)}
          </h5>
          <Input
            showColor={true}
            ...
            completeSelect={color =>
              this.handleGetColor('label/textStyle/fill', color)
            }
          />
          <Input
            type="number"
          ...
          <Input
            ...
            onChange={e =>
              this.handleChangeTheme('innerLabels/textStyle/fontSize', e)
            }
          />
          <Input
            showColor={true}
            ...
            onChange={e =>
              this.handleChangeTheme('innerLabels/textStyle/fill', e)
            }
            completeSelect={color =>
              this.handleGetColor('innerLabels/textStyle/fill', color)
            }
          />
        </TabSld>
        <TabSld title={getTransText('axis', pageLan)}>
          {/*坐标轴*/}
          <Input
            showColor={true}
            ...
            onChange={e =>
              this.handleChangeTheme('axis/~/label/textStyle/fill', e)
            }
            completeSelect={color =>
              this.handleGetColor('axis/~/label/textStyle/fill', color)
            }
          />
          <Input
            type="number"
          ...
          <Input
            ...
            completeSelect={color =>
              this.handleGetColor('axis/~/line/stroke', color)
            }
          />
          <Input
            type="number"
            ...
            onChange={e =>
              this.handleChangeTheme('axis/~/tickLine/lineWidth', e)
            }
          />
          <Input
            type="number"
          ...
          <Input
            ...
            completeSelect={color =>
              this.handleGetColor('axis/~/tickLine/stroke', color)
            }
          />
          <Input
            showColor={true}
            ...
            onChange={e =>
              this.handleChangeTheme('axis/~/grid/lineStyle/stroke', e)
            }
            completeSelect={color =>
              this.handleGetColor('axis/~/grid/lineStyle/stroke', color)
            }
          />
          <Input
            type="number"
            ...
            onChange={e =>
              this.handleChangeTheme('axis/~/grid/lineStyle/lineWidth', e)
            }
          />
        </TabSld>
        <TabSld title={getTransText('legend', pageLan)}>
          ...
          <Input
            ...
            completeSelect={color =>
              this.handleGetColor('legend/~/textStyle/fill', color)
            }
          />
          <Input
            showColor={true}
            ...
            completeSelect={color =>
              this.handleGetColor('legend/~/unCheckColor', color)
            }
          />
        </TabSld>
        <TabSld title={getTransText('tooltip', pageLan)}>
          ...
          <Input
            ...
            value={parseFloat(
              currentTheme.theme.tooltip['g2-tooltip'].fontSize,
            )}
            onChange={e =>
              this.handleChangeTheme('tooltip/g2-tooltip/fontSize', e, 'px')
            }
          />
          <Input
            type="number"
            ...
            value={parseFloat(
              currentTheme.theme.tooltip['g2-tooltip'].borderRadius,
            )}
            onChange={e =>
          ...
          {/* <Input
            ...
            value={parseFloat(
              currentTheme.theme.tooltip['g2-tooltip'].lineHeight,
            )}
            onChange={e =>
          ...
          <Input
            ...
            onChange={e =>
              this.handleChangeTheme('tooltip/g2-tooltip/color', e)
            }
            completeSelect={color =>
              this.handleGetColor('tooltip/g2-tooltip/color', color)
            }
          />
        </TabSld>
      </div>
