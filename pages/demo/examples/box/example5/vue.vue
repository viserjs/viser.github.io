<template>
  <div>
    <v-chart :forceFit="true" :height="height" :data="data" :scale="scale">
      <v-tooltip :showTitle="tooltipOpts.showTitle" :itemTpl="tooltipOpts.itemTpl" />
      <v-coord type="polar" :innerRadius="0.5" />
      <v-axis />
      <v-legend />
      <v-box position="x*range" :active="true" size="60" color="x" :tooltip="sereisTooltip"  />
    </v-chart>
  </div>
</template>
...
const sereisTooltip = ['x*low*q1*median*q3*high', (x, low, q1, median, q3, high) => {
  return {
    name: x,
    low,
    q1,
