...
export default class App extends React.Component {
    render() {
        ...
        >
            ...
            <Axis dataKey="type" label={{ offset: 10 }} title={null} />
            <Axis dataKey="value" position="right" title={null} tickLine={null} label={{ formatter: val => val + '%' }} />
            <StackBar position="type*value" color={['opinion', opinion => colorMap[opinion]]} />
        </Chart>
    }
}