    ...
    return (
      ...
      >
        ...
        >
          ...
          <Axis dataKey="date" title={null} line={{ stroke: '#000' }} grid={{ line: { stroke: '#d9d9d9' } }} />
          <Axis dataKey="times" title={{ textStyle: { fill: '#000' } }} line={{ stroke: '#000' }} grid={{ line: { stroke: '#d9d9d9', lineDash: [0, 0] } }} />
          <Area position="date*times" color={['grade',['#d8d8ff', '#6060ff']]} opacity={.8} shape="smooth"/>
        ...
        <View
          ...
          scale={markScale}
        >
          <Interval position="date*value" color={['type',['#ff7f00', '#093']]} size={3}/>
          <Point
            position="date*value"
