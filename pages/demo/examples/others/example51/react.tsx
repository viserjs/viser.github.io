...
export default class App extends React.Component {
  ...
  async componentDidMount() {
    const data = await getJSON('/assets/data/usa.geo-1.json');
    const airports = await getJSON('/assets/data/airport-1.json');
