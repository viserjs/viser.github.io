    ...
    return (
      <div id="mountNode">
        <div id="canvas1">
          ...
          >
            <Axis />
            <Area position="date*price" shape="smooth" opacity={.85}/>
          </Chart>
        </div>
        <div id="canvas2">
          <Chart
          ...
          >
            ...
            <Area position="date*price" active={false} shape="smooth" opacity={.85}/>
            <Brush type="x" dragable={true} onBrushmove={this.handleMove} onDragmove={this.handleMove}/>
          </Chart>
        </div>
      </div>
    );
