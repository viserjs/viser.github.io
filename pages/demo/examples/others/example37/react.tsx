...
import { Chart, Guide, Tooltip, Series, registerShape, Global } from 'viser-react';
...
export default class App extends React.Component {
    render() {
        return (
            <Chart container='mountNode' forceFit={true} height={window.innerHeight} data={data} padding={0} scale={scale}>
                <Tooltip />
                <Series
                    gemo="interval"
